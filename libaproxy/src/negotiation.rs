...
/// The type of assymetric key that must be generated by SVSM to decrypt secrets from the
/// attestation server.
#[derive(Serialize, Deserialize, Debug)]
...
pub enum NegotiationParam {
    ...
    /// A base64-encoded byte array. This could represent a ephemeral nonce or any other data the
...
pub struct NegotiationResponse {
    ...
    /// Type of assymetric key to generate.
